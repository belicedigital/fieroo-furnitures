...
@section('buttons')
<a href="{{url('admin/furnishings/create')}}" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="{{trans('generals.add')}}"><i class="fas fa-plus"></i></a>
@endsection
@section('content')
                    ...
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                        <div class="tab-pane fade show active" id="it-pages-tab" role="tabpanel" aria-labelledby="it-tab">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    @foreach($it_furnishings as $furnishing)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group" role="group">
                                                <a data-toggle="tooltip" data-placement="top" title="{{trans('generals.edit')}}" class="btn btn-default" href="{{route('furnishings.edit', $furnishing->id)}}"><i class="fa fa-edit"></i></a>
                                                <a data-toggle="tooltip" data-placement="top" title="{{trans('generals.variants')}}" class="btn btn-default" href="{{ url('admin/furnishings/'.$furnishing->furnishing_id.'/variants') }}"><i class="fas fa-swatchbook"></i></a>
                                                <form action="{{ route('furnishings.destroy', $furnishing->furnishing_id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        <div class="tab-pane fade" id="en-pages-tab" role="tabpanel" aria-labelledby="en-tab">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    @foreach($en_furnishings as $furnishing)
                                    <tr>
                                        <td>{{\Str::limit($furnishing->description, 50)}}</td>
                                        <td>{{$furnishing->price}}</td>
                                        <td>{{$furnishing->size}}</td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group" role="group">
                                                <a data-toggle="tooltip" data-placement="top" title="{{trans('generals.edit')}}" class="btn btn-default" href="{{route('furnishings.edit', $furnishing->id)}}"><i class="fa fa-edit"></i></a>
                                                <form action="{{ route('furnishings.destroy', $furnishing->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button data-toggle="tooltip" data-placement="top" title="{{trans('generals.delete')}}" class="btn btn-default"><i class="fa fa-trash"></i></button>
                                                </form>
