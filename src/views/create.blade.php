            ...
            <div class="card card-tabs">
                <div class="card-header p-0">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="it-tab" data-toggle="pill" href="#it-furnishings-tab" role="tab" aria-controls="it-furnishings-tabe" aria-selected="true">IT</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="en-tab" data-toggle="pill" href="#en-furnishings-tab" role="tab" aria-controls="en-furnishings-tab" aria-selected="false">EN</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <form action="{{route('furnishings.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="tab-content" id="custom-tabs-one-tabContent">
                            <div class="tab-pane fade show active" id="it-furnishings-tab" role="tabpanel" aria-labelledby="it-tab">
                                <div class="row">
                            ...
                            <div class="tab-pane fade" id="en-furnishings-tab" role="tabpanel" aria-labelledby="en-tab">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>{{trans('tables.stand')}}</strong>
                                            <select id="stand_type_id_en" name="stand_type_id_en" class="form-control" readonly disabled>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>{{trans('tables.size')}}</strong>
                                            <input type="text" name="size_en" class="form-control" value="{{ old('size_en') }}" readonly disabled>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>{{trans('tables.price')}}</strong>
                                            <input type="text" name="price_en" class="form-control" value="{{ old('price_en') }}" readonly disabled>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>{{trans('tables.color')}}</strong>
                                            <input type="text" name="color_en" class="form-control" value="{{ old('color_en') }}" readonly disabled>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
